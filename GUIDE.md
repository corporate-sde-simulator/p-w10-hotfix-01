...
> **Welcome to Product-Track Week 10, Hotfix 1!**
...
1. **Read the comments** at the top of `revenue_report.py` - they describe the problem
...
| File | Purpose |
|------|---------|
| `revenue_report.py` | The code with bugs - **fix this file** |
...
### Bug #1
**User Report / Alert:**
> "The SUM(amount) joins orders with order_items, so orders with"
...
### Bug #2
**User Report / Alert:**
> "This JOIN causes order amounts to be multiplied by number of line items"
...
### Bug #3
**User Report / Alert:**
> "gy): Q1 = 500.00 (200 + 200 + 100), Q2 = 450.00 (150 * 3)"
...
1. **Read the top comment block** in `revenue_report.py` carefully - it has:
